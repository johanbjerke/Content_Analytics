    ...
    var CustomIconRenderer = TableView.BaseCellRenderer.extend({
        ...
        render: function($td, cell) {
        	if (cell.field === 'Details') {
				...
				//cell.value=details;
				$td.html(details);
			} else if (cell.field === 'Details' || cell.field === 'Description' || cell.field === 'Title' || cell.field === 'Detection Search') {
				...
				} else if (cell.field === 'Data Availability') {
    ...
    var MitreMapTableRenderer = TableView.BaseCellRenderer.extend({
        ...
        render: function($td, cell) {
			...
			if(cellvalue != null) {
				...
				var celltext=values[0];
				var colorhex=values[1];
				var bgcoloropacity=values[2];
				var tooltip=values[3];

				$td.css("background-color","rgb("+hexToRgb(colorhex)+","+bgcoloropacity+")")
...
require(["jquery",
    ...
    function(
        ...
        $("label:contains('Data Source selection')").prop('title', 'Highlight which content uses the selected Data Sources. Data Sources are mapped to individual technologies.');
